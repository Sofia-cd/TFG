...
FILE *report, *comp_report, *stat_report, *timeMeasurements_report;
...
*/
{
  ...
  if (!quiet_flag) {
      sprintf(temp_buffer,"best.%s.nThreads%d",instance.name,omp_get_max_threads());
      TRACE ( printf("%s\n",temp_buffer); )
          report = fopen(temp_buffer, "w");
      sprintf(temp_buffer,"cmp.%s.nThreads%d",instance.name,omp_get_max_threads());
      TRACE ( printf("%s\n",temp_buffer); )
          comp_report = fopen(temp_buffer, "w");
      sprintf(temp_buffer,"stat.%s.nThreads%d",instance.name,omp_get_max_threads());
      TRACE ( printf("%s\n",temp_buffer); )
          stat_report = fopen(temp_buffer, "w");
      sprintf(temp_buffer,"timeMeasurements.%s.nThreads%d",instance.name,omp_get_max_threads());
      TRACE ( printf("%s\n",temp_buffer); )
