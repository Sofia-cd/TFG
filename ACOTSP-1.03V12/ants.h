...
extern long int global_best_tour; /* the best tour of all the colonies */

typedef struct {
	MPI_Request request;
	long int *foreign_tour;
} buffer_tours_struct;

extern buffer_tours_struct *foreign_tours;
extern long int *own_tour; /* own tours buffer */ 
